        ...
        <div className="relative flex flex-col gap-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0 flex-1">
              ...
              <h3 className="min-w-0 break-words font-display text-2xl font-bold uppercase tracking-wide text-white md:text-3xl">
                {hunt.title}
              </h3>
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.9fr)]">
            <div className="min-w-0 rounded-[1.5rem] border border-white/10 bg-black/20 p-5 backdrop-blur-sm">
              ...
              <div
                className={cn(
                  "mt-3 min-w-0 break-words font-display text-4xl font-bold leading-none md:text-5xl",
                  tone.value
                )}
              >
              ...
              {hunt.notes ? (
                <p className="mt-4 max-w-3xl break-words text-sm leading-7 text-silver/72">
                  {hunt.notes}
                </p>
              ) : null}
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className={cn("min-w-0 rounded-[1.35rem] border p-4", tone.stat)}>
                <div className="text-[11px] uppercase tracking-[0.28em] text-silver/45">
                  Bonuses
                </div>
                <div className="mt-2 min-w-0 break-words font-display text-2xl font-bold text-white">
                  {bonusCount !== undefined ? bonusCount : "—"}
                </div>
                <div className="mt-1 break-words text-xs text-silver/55">
              ...
              <div className={cn("min-w-0 rounded-[1.35rem] border p-4", tone.stat)}>
                ...
                <div className="mt-1 min-w-0 truncate text-xs text-silver/55">
