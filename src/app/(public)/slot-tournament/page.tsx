  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('/bracket-bg.jpg')",
      ...
      <div className="relative z-20 space-y-6 px-4 py-6 md:space-y-8 md:px-6 md:py-8 xl:px-8">
        <section
          className="relative overflow-hidden rounded-[12px] border border-white/10 px-5 py-6 sm:px-6 md:px-8 md:py-8"
          style={{
            background:
              "linear-gradient(180deg, rgba(6,11,19,0.82) 0%, rgba(4,8,14,0.92) 100%)",
            boxShadow:
